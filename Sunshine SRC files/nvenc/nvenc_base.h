...
namespace nvenc {
  ...
  public:
	...
	bool reconfigure_framerate(uint32_t num, uint32_t den);
  ...
  private:
	...
	NV_ENC_INITIALIZE_PARAMS init_params_snapshot{};  // versão "viva" do INIT usada no reconfigure
	NV_ENC_CONFIG            enc_config_snapshot{};   // versão "viva" do CONFIG usada no reconfigure
